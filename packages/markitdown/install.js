...
async function downloadBinaryFromNpm() {
  ...
  const tarballDownloadBuffer = await makeRequest(
    `https://registry.npmjs.org/${platformSpecificPackageName}/-/${platformSpecificPackageName.replace('@motesoftware/', '')}-${BINARY_DISTRIBUTION_VERSION}.tgz`
  )
...
if (!platformSpecificPackageName) {
  ...
  Object.keys(BINARY_DISTRIBUTION_PACKAGES).forEach((platform) => {
...
if (!isPlatformSpecificPackageInstalled()) {
  ...
  downloadBinaryFromNpm().catch((error) => {
